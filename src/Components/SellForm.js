...
function SellForm() {
  ...
  <div className="site-card-border-less-wrapper">
    ...
    >
        ...
        <option value="Julho">Junho</option>
        <option value="Agosto">Junho</option>
        <option value="Setembro">Junho</option>
        <option value="Outubro">Junho</option>
        <option value="Novembro">Junho</option>
        <option value="Dezembro">Junho</option>
